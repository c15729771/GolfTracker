...
urlpatterns = [
    ...
    path('TrackNow/getGameHolesByGameId', views.getGameHolesByGameId, name='getGameHolesByGameId'),
    path('TrackNow/getNewHoleModal', views.getNewHoleModal, name='getNewHoleModal'),
